...
<body>
  ...
  <div class="w-full min-h-screen flex flex-col items-center mt-10">
    <div class="w-[90%] lg:w-[50%]">
      <h1 class="uppercase text-lg font-bold text-white">
        <span>admin dashboard</span>
      </h1>
      <!-- A TABLE THAT CONTAINS ALL BLOG OR NEWS ALREADY UPLOADED -->
      <div id="table" class="w-full overflow-x-auto border border-gray-500 rounded shadow">

      </div>

      <!-- FORM FOR INPUT NEW BLOG OR NEWS -->
      <form action="../Model/input.php" method="post" enctype="multipart/form-data"
        ...
        <!-- FORM INPUT FOR HEADLINE -->
        <div class="my-3 w-full">
          <label for="default-input" class="block mb-2 text-sm font-semibold text-gray-900">Headline <span
              class="text-red-500">*</span></label>
          <input type="text" id="default-input" placeholder="Headline konten anda" name="headline"
        ...
        <div class="my-3 w-full">
          <label for="message" class="block mb-2 text-sm font-semibold text-gray-900">Deskripsi <span
              class="text-red-500">*</span></label>
          <textarea id="message" rows="4" name="desc"
            ...
            placeholder="Deskripsi dari konten anda..." required></textarea>
        </div>

        <!-- FILE INPUT FOR IMAGE -->
        <div class="my-3 w-full text-sm">
          <label for="formFile" class="mb-2 inline-block font-semibold text-neutral-700">
          ...
          <input
            ...
            type="file" id="formFile" name="imageFile" required />
        </div>
  ...
  <!-- FOOTER COMPONENT -->
  <div class="w-full border-t border-black bg-[#134BA2] flex justify-center items-center text-white" id="footer">
